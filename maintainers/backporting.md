...
to a release branch once it's merged, assign it a label of the form
...
This specifically affects the [`installer_test`] check. Note that it only runs after the other
tests, so it may take a while to appear.
