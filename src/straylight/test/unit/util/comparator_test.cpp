// straylight::nix::util::comparator tests
//
...
#include "straylight/nix/util/comparator.h"

namespace cmp = straylight::nix::util;
...
TEST_CASE("key_extractor creates reusable key function", "[comparator][key_extraction]") {
  ...
  // Use bool wrapper to avoid Catch2 tuple decomposition issues
