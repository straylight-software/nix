...
TEST_CASE("compile attrset with dynamic key", "[compiler][attrset][dynamic]") {
  ...
  ast::attribute_path path;
  path.segments_.push_back(ast::attribute_name{pos(), std::move(key_expr)});
...
TEST_CASE("compile attrset with mixed static and dynamic keys", "[compiler][attrset][dynamic]") {
  ...
  path1.segments_.push_back(ast::attribute_name{pos(), symbols.intern("x")});
  ...
  path2.segments_.push_back(ast::attribute_name{pos(), std::move(key_expr)});
  ...
  path3.segments_.push_back(ast::attribute_name{pos(), symbols.intern("y")});
...
TEST_CASE("compile select with mixed static and dynamic path", "[compiler][select][dynamic]") {
  ...
  ast::attribute_path path;
  path.segments_.push_back(ast::attribute_name{pos(), symbols.intern("a")});
  auto key_expr = make_expr(ast::expression_identifier{pos(), key_name});
  path.segments_.push_back(ast::attribute_name{pos(), std::move(key_expr)});
  path.segments_.push_back(ast::attribute_name{pos(), symbols.intern("c")});
...
TEST_CASE("compile closure capturing single variable", "[compiler][closure]") {
  ...
  x_path.segments_.push_back(ast::attribute_name{pos(), x_name});
...
TEST_CASE("compile attrset with inherit from expression", "[compiler][attrset][inherit]") {
  ...
  y_path.segments_.push_back(ast::attribute_name{pos(), y_name});
  ...
  src_path.segments_.push_back(ast::attribute_name{pos(), src_name});
...
TEST_CASE("compile attrset with multiple inherit attrs from expression",
  ...
  a_path.segments_.push_back(ast::attribute_name{pos(), a_name});
  ast::attribute_path b_path;
  b_path.segments_.push_back(ast::attribute_name{pos(), b_name});
  std::vector<ast::binding_variant> inner_bindings;
...
TEST_CASE("compile let with inherit from outer scope", "[compiler][let][inherit]") {
  ...
  outer_path.segments_.push_back(ast::attribute_name{pos(), outer_name});
...
TEST_CASE("compile attrset with two-segment path", "[compiler][attrset][multi-segment]") {
  ...
  ast::attribute_path path;
  path.segments_.push_back(ast::attribute_name{pos(), symbols.intern("a")});
  path.segments_.push_back(ast::attribute_name{pos(), symbols.intern("b")});
...
TEST_CASE("compile attrset with mixed single and multi-segment paths",
  ...
  ast::attribute_path path2;
  path2.segments_.push_back(ast::attribute_name{pos(), symbols.intern("a")});
  path2.segments_.push_back(ast::attribute_name{pos(), symbols.intern("b")});
...
TEST_CASE("compile attrset with merging multi-segment paths",
  ...
  ast::attribute_path path1;
  path1.segments_.push_back(ast::attribute_name{pos(), symbols.intern("a")});
  path1.segments_.push_back(ast::attribute_name{pos(), symbols.intern("b")});
  auto value1 = make_expr(ast::expression_integer{pos(), 1});
  ast::binding_attribute binding1{pos(), std::move(path1), std::move(value1)};

  ast::attribute_path path2;
  path2.segments_.push_back(ast::attribute_name{pos(), symbols.intern("a")});
  path2.segments_.push_back(ast::attribute_name{pos(), symbols.intern("c")});
  auto value2 = make_expr(ast::expression_integer{pos(), 2});
  ast::binding_attribute binding2{pos(), std::move(path2), std::move(value2)};
...
TEST_CASE("compile let with two-segment path", "[compiler][let][multi-segment]") {
  ...
  ast::attribute_path path;
  path.segments_.push_back(ast::attribute_name{pos(), a_name});
  path.segments_.push_back(ast::attribute_name{pos(), b_name});
  auto value = make_expr(ast::expression_integer{pos(), 42});
  ast::binding_attribute binding{pos(), std::move(path), std::move(value)};
...
TEST_CASE("compile let with three-segment path", "[compiler][let][multi-segment]") {
  ...
  path.segments_.push_back(ast::attribute_name{pos(), a_name});
  path.segments_.push_back(ast::attribute_name{pos(), b_name});
  path.segments_.push_back(ast::attribute_name{pos(), c_name});
  auto value = make_expr(ast::expression_integer{pos(), 1});
  ast::binding_attribute binding{pos(), std::move(path), std::move(value)};
...
TEST_CASE("compile let with merging multi-segment paths", "[compiler][let][multi-segment]") {
  ...
  ast::attribute_path path1;
  path1.segments_.push_back(ast::attribute_name{pos(), a_name});
  path1.segments_.push_back(ast::attribute_name{pos(), b_name});
  auto value1 = make_expr(ast::expression_integer{pos(), 1});
  ast::binding_attribute binding1{pos(), std::move(path1), std::move(value1)};

  ast::attribute_path path2;
  path2.segments_.push_back(ast::attribute_name{pos(), a_name});
  path2.segments_.push_back(ast::attribute_name{pos(), c_name});
  auto value2 = make_expr(ast::expression_integer{pos(), 2});
  ast::binding_attribute binding2{pos(), std::move(path2), std::move(value2)};
...
TEST_CASE("compile with expression with inner with shadowing", "[compiler][with]") {
  ...
  x_path1.segments_.push_back(ast::attribute_name{pos(), x_name});
  ...
  x_path2.segments_.push_back(ast::attribute_name{pos(), x_name});
