...
#include "straylight/language/eval/eval.h"
#include "straylight/language/parse/parser.h"

namespace ast = straylight::language::ast;
namespace parse = straylight::language::parse;
namespace eval = straylight::language::eval;
