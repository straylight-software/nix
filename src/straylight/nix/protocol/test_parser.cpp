...
void test_client_hello() {
  ...
  auto data = read_file("src/straylight/nix/protocol/captures/client_hello.bin");
...
void test_query_path_info_request() {
  ...
  auto data = read_file("src/straylight/nix/protocol/captures/query_path_info_request.bin");
  std::cout << "Read " << data.size() << " bytes\n";
  hexdump(data);
...
void test_query_path_info_response() {
  ...
  auto data = read_file("src/straylight/nix/protocol/captures/query_path_info.bin");
  std::cout << "Read " << data.size() << " bytes\n";
  hexdump(data);
