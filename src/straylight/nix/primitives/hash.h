...
[[nodiscard]] constexpr std::size_t hash_size(Algorithm algo) noexcept {
  switch (algo) {
    case Algorithm::MD5:
      return hash_config::md5_size;
    case Algorithm::SHA1:
      return hash_config::sha1_size;
    case Algorithm::SHA256:
      return hash_config::sha256_size;
    case Algorithm::SHA512:
      return hash_config::sha512_size;
    case Algorithm::BLAKE3:
      return hash_config::blake3_size;
  }
...
class Hash {
public:
  static constexpr std::size_t max_size = hash_config::max_hash_size;
...
[[nodiscard]] inline Hash store_path_hash(std::string_view data) {
  return sha256(data).compress(hash_config::store_path_hash_size);
}
