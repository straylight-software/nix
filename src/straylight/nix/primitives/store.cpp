// store.cpp - Log-structured io_uring-native store implementation
...
static auto serialize_register_payload(const register_path_payload& payload)
    -> std::vector<std::byte> {
  return primitives::serialize(payload);
}
