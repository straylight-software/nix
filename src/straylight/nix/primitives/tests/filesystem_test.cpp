// straylight::nix::primitives::filesystem tests
//
...
#include "straylight/nix/primitives/filesystem/file_lock.h"
#include "straylight/nix/primitives/filesystem/mmap.h"
#include "straylight/nix/primitives/filesystem/temp.h"

namespace fs = straylight::nix::primitives::filesystem;
