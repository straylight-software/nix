...
private:
   ...
   *
   * We don't verify the contents of both layers on the assumption that the lower layer is far
   * bigger, and also the observation that anything not in the upper db the overlayfs doesn't yet
   * care about.
   */
