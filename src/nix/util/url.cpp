...
ParsedURL parseURL(std::string_view url, bool lenient) try {
...
ParsedURL parseURLRelative(std::string_view urlS, const ParsedURL& base) try {
...
StringMap decodeQuery(std::string_view query, bool lenient) try {
