...
// ─────────────────────────────────────────────────────────────────────────────
// Resource exhaustion and blocking
// ─────────────────────────────────────────────────────────────────────────────

TEST_CASE("pool get blocks when capacity exhausted", "[pool][capacity]") {
...
TEST_CASE("pool factory exception does not leak in use count", "[pool][exception]") {
...
TEST_CASE("pool property tests", "[pool][property]") {
  rc::prop("count never exceeds in use plus idle", []() {
    ...
    auto num_acquisitions = *rc::gen::inRange<size_t>(1, 10);
