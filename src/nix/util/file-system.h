 ...
 */
std::filesystem::path createTempDir(const std::filesystem::path& tmpRoot = "",
 ...
 */
std::filesystem::path makeTempPath(const std::filesystem::path& root,
 ...
 */
bool chmodIfNeeded(const std::filesystem::path& path, mode_t mode,
