...
long time. Determinate Nix now computes `revCount` using multiple threads, making it much faster.
...
This release fixes an assertion failure in `nix flake check`. PR:
[DeterminateSystems/nix-src#252](https://github.com/DeterminateSystems/nix-src/pull/252)

**Full Changelog**:
[v3.12.1...v3.12.2](https://github.com/DeterminateSystems/nix-src/compare/v3.12.1...v3.12.2)
