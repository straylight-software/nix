...
public:
   ...
   */
  static std::string to_string(int val) { return to_string_signed(val); }
   ...
   * since C++11) in older C++ implementations.
   */
  static std::string to_string(long val) { return to_string_signed(val); }
   ...
   * since C++11) in older C++ implementations.
   */
  static std::string to_string(long long val) { return to_string_signed(val); }
#endif
   ...
   * since C++11) in older C++ implementations.
   */
  static std::string to_string(unsigned val) { return to_string_unsigned(val); }
   ...
   * since C++11) in older C++ implementations.
   */
  static std::string to_string(unsigned long val) { return to_string_unsigned(val); }
   ...
   * since C++11) in older C++ implementations.
   */
  static std::string to_string(unsigned long long val) { return to_string_unsigned(val); }
#endif
