...
// NOTE: The #[link(name = "seccomp")] attribute is removed because we link
// libseccomp via Buck2's prebuilt_cxx_library in third-party/rust/libseccomp/BUCK.
// Using both would cause duplicate/conflicting link flags.
unsafe extern "C" {
