...
const _: () = {
  ...
  ["Alignment of virtio_mem_req_unplug"][::std::mem::align_of::<virtio_mem_req_unplug>() - 8usize];
...
const _: () = {
  ...
  ["Alignment of virtio_mem_resp_state"][::std::mem::align_of::<virtio_mem_resp_state>() - 2usize];
