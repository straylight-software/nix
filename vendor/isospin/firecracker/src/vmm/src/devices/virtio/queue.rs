...
impl Queue {
    ...
    pub fn initialize<M: GuestMemory + GuestMemoryBackend>(&mut self, mem: &M) -> Result<(), QueueError> {
        if !self.ready {
...
mod verification {
    ...
    use super::*;
    use crate::vstate::memory::{Bytes, FileOffset, GuestAddress, GuestMemory, GuestMemoryBackend, MmapRegion};
