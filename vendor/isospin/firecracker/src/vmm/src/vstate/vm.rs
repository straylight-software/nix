...
use crate::vstate::memory::{
  GuestMemory, GuestMemoryBackend, GuestMemoryExtension, GuestMemoryMmap, GuestMemoryRegion,
...
impl Vm {
  ...
  pub fn register_dram_memory_regions(
    ...
    for region in regions {
      ...
      let arcd_region = Arc::new(GuestRegionMmapExt::dram_from_mmap_region(region, next_slot));
