...
mod tests {
  ...
  fn test_mmds() {
    ...
    mmds
      .put_data(serde_json::from_str(mmds_json).unwrap())
      .unwrap();
    ...
    mmds
      .patch_data(serde_json::from_str(patch_json).unwrap())
      .unwrap();
  ...
  fn test_get_value() {
    for imds_compat in [false, true] {
      ...
      for format in [OutputFormat::Imds, OutputFormat::Json] {
        ...
        assert_eq!(
          mmds
            .get_value("/invalid_path".to_string(), format)
            .unwrap_err()
            .to_string(),
        ...
        match (imds_compat, format) {
          (false, OutputFormat::Imds) | (true, _) => assert_eq!(
            mmds
              .get_value("/age".to_string(), format)
              .err()
              .unwrap()
              .to_string(),
        ...
        match (imds_compat, format) {
          (false, OutputFormat::Imds) | (true, _) => assert_eq!(
            mmds
              .get_value("/phones/".to_string(), format)
              .err()
              .unwrap()
              .to_string(),
            MmdsDatastoreError::UnsupportedValueType.to_string()
        ...
        match (imds_compat, format) {
          (false, OutputFormat::Imds) | (true, _) => assert_eq!(
            mmds
              .get_value("/member".to_string(), format)
              .err()
              .unwrap()
              .to_string(),
            MmdsDatastoreError::UnsupportedValueType.to_string()
        ...
        match (imds_compat, format) {
          (false, OutputFormat::Imds) | (true, _) => assert_eq!(
            mmds
              .get_value("/shares_percentage".to_string(), format)
              .err()
              .unwrap()
              .to_string(),
            MmdsDatastoreError::UnsupportedValueType.to_string()
        ...
        match (imds_compat, format) {
          (false, OutputFormat::Imds) | (true, _) => assert_eq!(
            mmds
              .get_value("/balance".to_string(), format)
              .err()
              .unwrap()
              .to_string(),
            MmdsDatastoreError::UnsupportedValueType.to_string(),
