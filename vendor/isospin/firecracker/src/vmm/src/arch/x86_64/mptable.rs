...
use crate::vstate::memory::{
  Address, ByteValued, Bytes, GuestAddress, GuestMemory, GuestMemoryBackend, GuestMemoryMmap,
};
...
pub fn setup_mptable(
  ...
  mem
    .write_slice(&vec![0; mp_size], base_mp)
...

  {
    ...
    mem
      .write_obj(mpc_table, table_base)
...
mod tests {
  ...
  fn mpc_table_checksum() {
    ...
    mem
      .write_volatile_to(mpc_offset, &mut buffer, mpc_table.length as usize)
      .unwrap();
    assert_eq!(
      buffer
        .iter()
