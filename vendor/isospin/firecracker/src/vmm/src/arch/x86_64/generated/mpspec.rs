...
const _: () = {
  ...
  ["Offset of field: mpf_intel::signature"][::std::mem::offset_of!(mpf_intel, signature) - 0usize];
...
const _: () = {
  ...
  ["Offset of field: mpc_table::signature"][::std::mem::offset_of!(mpc_table, signature) - 0usize];
  ...
  ["Offset of field: mpc_table::productid"][::std::mem::offset_of!(mpc_table, productid) - 16usize];
...
const _: () = {
  ...
  ["Offset of field: mpc_cpu::featureflag"][::std::mem::offset_of!(mpc_cpu, featureflag) - 8usize];
...
const _: () = {
  ...
  ["Offset of field: mpc_ioapic::apicaddr"][::std::mem::offset_of!(mpc_ioapic, apicaddr) - 4usize];
};
#[repr(C)]
#[derive(Debug, Default, Copy, Clone, PartialEq)]
...
const _: () = {
  ...
  ["Offset of field: mpc_lintsrc::irqtype"][::std::mem::offset_of!(mpc_lintsrc, irqtype) - 1usize];
  ["Offset of field: mpc_lintsrc::irqflag"][::std::mem::offset_of!(mpc_lintsrc, irqflag) - 2usize];
...
const _: () = {
  ...
  ["Offset of field: mpc_oemtable::length"][::std::mem::offset_of!(mpc_oemtable, length) - 4usize];
