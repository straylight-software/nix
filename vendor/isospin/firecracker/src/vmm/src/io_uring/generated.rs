...
const _: () = {
  ...
  ["Offset of field: io_uring_sqe::opcode"][::std::mem::offset_of!(io_uring_sqe, opcode) - 0usize];
  ["Offset of field: io_uring_sqe::flags"][::std::mem::offset_of!(io_uring_sqe, flags) - 1usize];
  ["Offset of field: io_uring_sqe::ioprio"][::std::mem::offset_of!(io_uring_sqe, ioprio) - 2usize];
...
const _: () = {
  ...
  ["Alignment of io_uring_files_update"][::std::mem::align_of::<io_uring_files_update>() - 8usize];
...
const _: () = {
  ...
  ["Alignment of io_uring_rsrc_update2"][::std::mem::align_of::<io_uring_rsrc_update2>() - 8usize];
...
const _: () = {
  ...
  ["Offset of field: io_uring_probe::resv"][::std::mem::offset_of!(io_uring_probe, resv) - 2usize];
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
  ["Size of io_uring_buf_ring__bindgen_ty_1__bindgen_ty_2__bindgen_ty_1"]
    [::std::mem::size_of::<io_uring_buf_ring__bindgen_ty_1__bindgen_ty_2__bindgen_ty_1>() - 0usize];
  ["Alignment of io_uring_buf_ring__bindgen_ty_1__bindgen_ty_2__bindgen_ty_1"][::std::mem::align_of::<
...
const _: () = {
  ...
  ["Offset of field: io_uring_buf_ring__bindgen_ty_1__bindgen_ty_2::__empty_bufs"]
    [::std::mem::offset_of!(io_uring_buf_ring__bindgen_ty_1__bindgen_ty_2, __empty_bufs) - 0usize];
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
  ["Size of io_uring_sync_cancel_reg"][::std::mem::size_of::<io_uring_sync_cancel_reg>() - 64usize];
