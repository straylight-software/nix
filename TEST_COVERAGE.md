...
- `stripIndentation` tests have incorrect expected output - need to verify actual `stripIndentation` behavior
...
- URL tests require additional `-lboost_url` linker flag
